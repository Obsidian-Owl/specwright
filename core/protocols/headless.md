...
| Inner-loop integration test failure (2 fix attempts exhausted) | Ask: fix now / skip | **Skip and record** | Integration tests are environment-dependent; headless environments may lack infrastructure. Record skip in headless-result.json. |
